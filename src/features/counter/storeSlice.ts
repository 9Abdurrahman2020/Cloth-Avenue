...
export const { setWomenProduct, setWomenSelectedCategory, setCartProduct, setMenSelectedCategory, setMenProduct, setAllProducts, setStatus, setSingleProduct, setCategoryBasedProduct } = storeSlice.actions;
