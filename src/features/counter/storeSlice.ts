...
import { ICart, initialProduct, InitialState, IProduct, TMenSelectedCategory, TStatus, TWomenSelectedCategory } from '../Types';
...
export const { setWomenProduct, setWomenSelectedCategory, setCartProduct, setMenSelectedCategory, setMenProduct, setAllProducts, setStatus, setSingleProduct, setCategoryBasedProduct, setCartPrice, removeCartProduct } = storeSlice.actions;
